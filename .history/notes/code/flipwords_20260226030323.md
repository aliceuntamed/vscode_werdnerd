...
After installing the component, import it into your page or component file. The `Flipwords` component requires a `werds` array and accepts optional `duration` and `className` props.
