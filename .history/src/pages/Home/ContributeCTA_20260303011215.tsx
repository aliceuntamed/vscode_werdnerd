...
... <Feather className="w-5 h-5 text-white drop-shadow-[0_0_4px_rgba(255,255,255,0.4)]" />
  ...
  return (
    ...
    >
      ...
      <Link
        to="/submit"
        className="
          inline-flex items-center gap-2 px-6 py-3 rounded-lg font-heading text-lg text-white
      ...
      >
        <Plus className="w-5 h-5 text-white drop-shadow-[0_0_4px_rgba(255,255,255,0.4)]" />
        Submit a Word
      </Link>
    </div>
  );
